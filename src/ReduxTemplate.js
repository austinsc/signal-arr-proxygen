...
export default function(hub, options = {}) {
  return [
    ...
    '',
    `// Action Types (Client)`,
    `${_generateClientActionTypes(hub, options.clientVar || hub.Name)}`,
    '',
    `// Action Types (Server)`,
    `${_generateServerActionTypes(hub, options.clientVar || hub.Name)}`,
    '',
    `// Action Creators (Client)`,
    `${_generateClientActionCreators(hub, options.clientVar || hub.Name)}`,
    '',
    `// Action Creators (Server)`,
    `${_generateServerActionCreators(hub, options.clientVar || hub.Name)}`,
    '',
    `// Self Registration`,
    `${_generateSelfRegistration(hub, options.clientVar || hub.Name)}`,
    '',
    `/** End ${hub.Name} **/`,
    ''
  ].join('\r\n');

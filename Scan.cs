...
public class Startup
{
    ...
    public async Task<object> Invoke(object input)
    {
        ...
        var hubBaseType = Type.ReflectionOnlyGetType("Microsoft.AspNet.SignalR.Hubs.HubBase, Microsoft.AspNet.SignalR.Core", true, true);
        ...
        return ass.DefinedTypes.Where(x => !x.IsAbstract && IsDerivedOfGenericType(x, hubGenericType)).Select(x => new Hub
        {
            ...
            Server = x.GetMethods(BindingFlags.DeclaredOnly|BindingFlags.Instance|BindingFlags.Public)
            .Select(y => new Method
            {
                Name = y.Name,
